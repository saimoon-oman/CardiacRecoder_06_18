...
public class RecordListEditAdapter extends ArrayAdapter<Record> {

    private Context mContext;
    int mResource;

    public RecordListEditAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Record> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.row_data_layout_edit_delete, parent, false);
